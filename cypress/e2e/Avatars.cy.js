...
// В некоторых случаях выдаёт ошибку, что неверно введён номер карты и так далее. Данный поля выдают ошибку. При этом кейс проходит и смена аватара проходит успешно. 